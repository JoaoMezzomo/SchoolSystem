    ...
    <div class="container-fluid bg-light" style="height: 100%;">
        ...
        <div class="row">
            <div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                ...
                <asp:TextBox ID="txtLogin" type="text" class="form-text form-control obrigatorio" style="width:100%;" runat="server" MaxLength="15"></asp:TextBox>
            ...
            <div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                ...
                <asp:TextBox ID="txtSenha" type="password" class="form-text form-control obrigatorio" style="width:100%;" runat="server" MaxLength="30"></asp:TextBox>
            ...
            <div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3 pt-1">
                ...
                <asp:DropDownList ID="ddlPermissao" class="form-control obrigatorio" style="width:100%;" runat="server"></asp:DropDownList>
            ...
            <div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                ...
                <asp:TextBox ID="txtCPF" type="text" class="form-text form-control" style="width:100%;" runat="server" MaxLength="30"></asp:TextBox>
            </div>
        </div>
        <div class="row pt-0 pt-sm-0 pt-md-3 pt-lg-3 pt-xl-3">
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                ...
                <asp:TextBox ID="txtNome" type="text" class="form-text form-control obrigatorio" style="width:100%;" runat="server" MaxLength="50"></asp:TextBox>
            ...
            <div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                ...
                <asp:TextBox ID="txtIdade" type="text" class="form-text form-control" style="width:100%;" runat="server" MaxLength="3"></asp:TextBox>
            </div>
            <div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3 pt-1">
                <asp:Label ID="lblSexo" for="ddlSexo" class="text-roxo" runat="server" Text="Sexo"></asp:Label>
                <asp:DropDownList ID="ddlSexo" class="form-control" style="width:100%;" runat="server"></asp:DropDownList>
            </div>
        </div>
        <div class="row mt-0 mt-sm-0 mt-md-3 mt-lg-3 mt-xl-3">
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                ...
                <asp:TextBox ID="txtEndereco" type="text" class="form-text form-control" style="width:100%;" runat="server" MaxLength="100"></asp:TextBox>
            </div>
            <div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                <asp:Label ID="lblTelFixo" for="txtTelFixo" class="text-roxo" runat="server" Text="Telefone Fixo"></asp:Label>
                <asp:TextBox ID="txtTelFixo" type="text" class="form-text form-control" style="width:100%;" runat="server" MaxLength="50"></asp:TextBox>
            </div>
            <div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                <asp:Label ID="lblTelCelular" for="txtTelCelular" class="text-roxo" runat="server" Text="Telefone Celular"></asp:Label>
                <asp:TextBox ID="txtTelCelular" type="text" class="form-text form-control" style="width:100%;" runat="server" MaxLength="50"></asp:TextBox>
            </div>
        </div>
        <div class="row mt-0 mt-sm-0 mt-md-3 mt-lg-3 mt-xl-3">
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <asp:Label ID="lblNomePai" for="txtNomePai" class="text-roxo" runat="server" Text="Nome do Pai"></asp:Label>
                <asp:TextBox ID="txtNomePai" type="text" class="form-text form-control" style="width:100%;" runat="server" MaxLength="50"></asp:TextBox>
            </div>
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <asp:Label ID="lblNomeMae" for="txtNomeMae" class="text-roxo" runat="server" Text="Nome da Mãe"></asp:Label>
                <asp:TextBox ID="txtNomeMae" type="text" class="form-text form-control" style="width:100%;" runat="server" MaxLength="50"></asp:TextBox>
            </div>
        </div>
        <div class="row mt-0 mt-sm-0 mt-md-3 mt-lg-3 mt-xl-3">
            <div class="col-12">
